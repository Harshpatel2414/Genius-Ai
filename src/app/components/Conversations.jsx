...
//   if (
//     !chatHistory ||
//     chatHistory.every((category) => Object.values(category)[0].length === 0)
//   ) {
//     return (
...
//   return (
//     <div className="mt-2 pt-1 space-y-2 overflow-y-auto max-h-80 min-h-40 hide-scrollbar">
//       {chatHistory.map((category, index) => (
//         <div key={index}>
...
//                         className="p-2 bg-gray-50 rounded truncate drop-shadow-sm"
//                       >
//                         {conversation.title}
//                       </li>
//                     ))}
...
const Conversations = ({ chatHistory ,setOpen,setActiveTab}) => {
  const customNames = {
    today: "Today",
    yesterday: "Yesterday",
